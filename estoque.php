...
$sql = 'SELECT SUM(quantity * valor_unitario) as total FROM estoque';
$stm = $conexao->prepare($sql);
$stm->execute();
...
<body>
    ...
    <div class="d-flex flex-end" style="margin: 20px; justify-content: flex-end">
        <a type="button" class="btn btn-warning" href="entrada.php">Adicionar entrada</a>
        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#CadastrarModal">Adicionar produto</button>
    </div>
